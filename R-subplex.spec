...
Version  : 1.9
Release  : 43
URL      : https://cran.r-project.org/src/contrib/subplex_1.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/subplex_1.9.tar.gz
...
%setup -q -n subplex
pushd ..
cp -a subplex buildavx2
popd
pushd ..
cp -a subplex buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720458086
...
/usr/lib64/R/library/subplex/doc/index.html
...
/usr/lib64/R/library/subplex/tests/tinytest.R
/usr/lib64/R/library/subplex/tinytest/test-roxytest-tests-subplex.R

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/subplex/libs/subplex.so
/V4/usr/lib64/R/library/subplex/libs/subplex.so
